...
REM
REM Generated by Vivado on Thu Jul 31 16:28:58 +0530 2025
...
echo "xvlog --incr --relax -prj logic_gates_tb_vlog.prj"
call xvlog  --incr --relax -prj logic_gates_tb_vlog.prj -log xvlog.log
