...
REM
REM Generated by Vivado on Fri Aug 01 17:38:48 +0530 2025
...
echo "xvlog --incr --relax -prj Structural_modeling_tb_vlog.prj"
call xvlog  --incr --relax -prj Structural_modeling_tb_vlog.prj -log xvlog.log
